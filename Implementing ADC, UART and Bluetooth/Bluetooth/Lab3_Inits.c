/**
 * EE/CSE 474: Lab3 drivers starter code for Lab 3 task 2b
 */
...
void switches_J_Init() {
  ...
  // User SWs
  GPIODIR_J = 0x0; // Port J for SW1 and SW2 as inputs
  GPIODEN_J = 0x3; // Set PJ0 and PJ1 to digital port
  GPIOPUR_J = 0x3; // Set PJ0 and PJ1 as peripheral signals
}
...
void UART_Init(void) {
  ...
  UARTCTL_3 = 0x0;
  UARTLCRH_3 |= 0x60; // 8 bits with no parity and 1 stop bit
  UARTCC_3 = 0x5;
  UARTIBRD_3 = 104;
  UARTFBRD_3 = 11;
  UARTCTL_3 |= 0x301;
  
  GPIOAFSEL_A |= 0x30; // PA4 and PA5 - 0011.0000
  GPIODEN_A |= 0x30;
  GPIOPCTL_A |= 0x110000;
}
